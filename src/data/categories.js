export const CATEGORIES = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { id: 'nuclear-structure',  label: 'Nuclear Structure & Binding' },
          { id: 'nuclear-models',     label: 'Nuclear Models' },
          { id: 'radioactive-decay',  label: 'Radioactive Decay' },
          { id: 'nuclear-reactions',  label: 'Nuclear Reactions' },
          { id: 'fission-fusion',     label: 'Fission & Fusion' },
          { id: 'nucleosynthesis',    label: 'Nucleosynthesis' },
          { id: 'neutron-stars-matter', label: 'Neutron Stars & Dense Matter' },
          { id: 'exotic-nuclei',      label: 'Exotic & Halo Nuclei' },
        ],
      },
      {
        id: 'plasma-fluids',
        label: 'Plasma & Fluid Dynamics',
        children: [
          { id: 'fluid-fundamentals', label: 'Fluid Fundamentals' },
          { id: 'turbulence',         label: 'Turbulence' },
          { id: 'magnetohydrodynamics', label: 'Magnetohydrodynamics' },
          { id: 'plasma-kinetics',    label: 'Plasma Kinetic Theory' },
          { id: 'plasma-waves',       label: 'Plasma Waves & Instabilities' },
          { id: 'fusion-confinement', label: 'Fusion Confinement' },
          { id: 'astrophysical-fluids', label: 'Astrophysical Fluids' },
          { id: 'nonlinear-dynamics', label: 'Nonlinear Dynamics & Chaos' },
        ],
      },
      {
        id: 'laws-and-rules',
        label: 'Laws, Rules & Effects',
        children: [
          { id: 'mechanics-laws',     label: 'Mechanics & Gravity Laws' },
          { id: 'em-laws',            label: 'Electromagnetism Laws' },
          { id: 'thermo-gas-laws',    label: 'Thermodynamics & Gas Laws' },
          { id: 'optics-wave-laws',   label: 'Optics & Wave Laws' },
          { id: 'quantum-rules',      label: 'Quantum Rules & Principles' },
          { id: 'atomic-spectral-laws', label: 'Atomic & Spectral Laws' },
        ],
      },
